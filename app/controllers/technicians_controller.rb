class TechniciansController < ApplicationController
  ...
  def import
    ...
    redirect_to root_url, notice: "Technician Data Imported"
  end
  ...
  private
    ...
    def technician_params
      params.require(:technician).permit(:fname, :lname, :avatar, :active, :email, :group, :start_date, :leave_date, :vehicle_operator, :hourly_labor_rate_cents)
    end
end
