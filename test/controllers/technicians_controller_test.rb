...
class TechniciansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create technician" do
    assert_difference('Technician.count') do
      post technicians_url, params: { technician: { active: @technician.active, avatar: @technician.avatar, fname: @technician.fname, lname: @technician.lname } }
    end
  ...
  test "should update technician" do
    patch technician_url(@technician), params: { technician: { active: @technician.active, avatar: @technician.avatar, fname: @technician.fname, lname: @technician.lname } }
