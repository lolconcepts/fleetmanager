...
class InspectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inspection" do
    assert_difference('Inspection.count') do
      post inspections_url, params: { inspection: { active: @inspection.active, description: @inspection.description, inspection_type_id: @inspection.inspection_type_id } }
    end
  ...
  test "should update inspection" do
    patch inspection_url(@inspection), params: { inspection: { active: @inspection.active, description: @inspection.description, inspection_type_id: @inspection.inspection_type_id } }
